...
class AlSukrofScreen extends StatefulWidget {
  const AlSukrofScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlSukrofScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(43); i++) {
      verses += quran.getVerse(43, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
