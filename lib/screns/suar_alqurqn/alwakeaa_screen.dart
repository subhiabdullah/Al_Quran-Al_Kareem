...
class AlWakeaaScreen extends StatefulWidget {
  const AlWakeaaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlWakeaaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(56); i++) {
      verses += quran.getVerse(56, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
