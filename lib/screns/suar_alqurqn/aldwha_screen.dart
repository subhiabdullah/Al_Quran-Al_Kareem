...
class AlDwhaScreen extends StatefulWidget {
  const AlDwhaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlDwhaScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(93); i++) {
      verses += quran.getVerse(93, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
