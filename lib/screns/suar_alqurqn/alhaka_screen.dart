...
class AlHakaScreen extends StatefulWidget {
  const AlHakaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlHakaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(69); i++) {
      verses += quran.getVerse(69, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
