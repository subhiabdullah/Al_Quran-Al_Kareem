...
class YousofScreen extends StatefulWidget {
  const YousofScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<YousofScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(12); i++) {
      verses += quran.getVerse(12, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
