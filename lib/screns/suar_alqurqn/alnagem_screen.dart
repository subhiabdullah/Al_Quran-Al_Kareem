...
class AlNagemScreen extends StatefulWidget {
  const AlNagemScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlNagemScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(53); i++) {
      verses += quran.getVerse(53, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
