...
class AlAhkafScreen extends StatefulWidget {
  const AlAhkafScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlAhkafScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(46); i++) {
      verses += quran.getVerse(46, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
