...
class AlSafScreen extends StatefulWidget {
  const AlSafScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlSafScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(61); i++) {
      verses += quran.getVerse(61, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
