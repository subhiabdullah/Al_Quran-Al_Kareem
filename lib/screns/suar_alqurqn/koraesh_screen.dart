...
class KoraeshScreen extends StatefulWidget {
  const KoraeshScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<KoraeshScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(106); i++) {
      verses += quran.getVerse(106, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
