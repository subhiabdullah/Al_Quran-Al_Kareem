...
class AlFatehScreen extends StatefulWidget {
  const AlFatehScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlFatehScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(48); i++) {
      verses += quran.getVerse(48, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
