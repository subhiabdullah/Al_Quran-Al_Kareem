...
class AlTareqScreen extends StatefulWidget {
  const AlTareqScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlTareqScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(86); i++) {
      verses += quran.getVerse(86, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
