...
class AlNaserScreen extends StatefulWidget {
  const AlNaserScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlNaserScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(110); i++) {
      verses += quran.getVerse(110, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
