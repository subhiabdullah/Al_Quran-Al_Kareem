...
class AlHasherScreen extends StatefulWidget {
  const AlHasherScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlHasherScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(59); i++) {
      verses += quran.getVerse(59, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
