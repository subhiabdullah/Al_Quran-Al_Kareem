...
class kafarScreen extends StatefulWidget {
  const kafarScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<kafarScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(40); i++) {
      verses += quran.getVerse(40, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
