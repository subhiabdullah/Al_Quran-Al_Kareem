...
class AlKalamScreen extends StatefulWidget {
  const AlKalamScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlKalamScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(68); i++) {
      verses += quran.getVerse(68, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
