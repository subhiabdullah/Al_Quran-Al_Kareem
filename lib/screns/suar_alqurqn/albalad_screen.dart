...
class AlBaladScreen extends StatefulWidget {
  const AlBaladScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlBaladScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(90); i++) {
      verses += quran.getVerse(90, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
