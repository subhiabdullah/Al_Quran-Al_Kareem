...
class AlBaenaScreen extends StatefulWidget {
  const AlBaenaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlBaenaScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(98); i++) {
      verses += quran.getVerse(98, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
