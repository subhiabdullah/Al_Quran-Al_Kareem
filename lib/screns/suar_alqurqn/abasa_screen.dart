...
class AbasaScreen extends StatefulWidget {
  const AbasaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AbasaScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(80); i++) {
      verses += quran.getVerse(80, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
