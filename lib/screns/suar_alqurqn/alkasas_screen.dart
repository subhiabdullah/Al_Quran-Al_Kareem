...
class AlkasasScreen extends StatefulWidget {
  const AlkasasScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlkasasScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(28); i++) {
      verses += quran.getVerse(28, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
