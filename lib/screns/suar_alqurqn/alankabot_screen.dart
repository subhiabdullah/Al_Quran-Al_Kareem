...
class AlAnkabotScreen extends StatefulWidget {
  const AlAnkabotScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlAnkabotScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(29); i++) {
      verses += quran.getVerse(29, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
