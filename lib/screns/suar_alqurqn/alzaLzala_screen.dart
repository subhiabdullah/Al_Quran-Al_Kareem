...
class AlZalzalaScreen extends StatefulWidget {
  const AlZalzalaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlZalzalaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(99); i++) {
      verses += quran.getVerse(99, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
