...
class AlFagerScreen extends StatefulWidget {
  const AlFagerScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlFagerScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(89); i++) {
      verses += quran.getVerse(89, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
