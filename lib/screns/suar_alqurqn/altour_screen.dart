...
class AlTourScreen extends StatefulWidget {
  const AlTourScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlTourScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(52); i++) {
      verses += quran.getVerse(52, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
