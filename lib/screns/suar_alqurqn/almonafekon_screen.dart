...
class AlMonafekonScreen extends StatefulWidget {
  const AlMonafekonScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlMonafekonScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(63); i++) {
      verses += quran.getVerse(63, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
