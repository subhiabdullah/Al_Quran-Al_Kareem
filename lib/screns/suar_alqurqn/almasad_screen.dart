...
class AlMasadScreen extends StatefulWidget {
  const AlMasadScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlMasadScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(111); i++) {
      verses += quran.getVerse(111, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
