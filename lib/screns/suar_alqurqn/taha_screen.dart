...
class TahaScreen extends StatefulWidget {
  const TahaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<TahaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(20); i++) {
      verses += quran.getVerse(20, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
