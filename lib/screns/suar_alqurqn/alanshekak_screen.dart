...
class AlAnshekakScreen extends StatefulWidget {
  const AlAnshekakScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlAnshekakScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(84); i++) {
      verses += quran.getVerse(84, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
