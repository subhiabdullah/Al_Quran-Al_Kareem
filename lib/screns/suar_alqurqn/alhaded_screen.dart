...
class AlHadedScreen extends StatefulWidget {
  const AlHadedScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlHadedScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(57); i++) {
      verses += quran.getVerse(57, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
