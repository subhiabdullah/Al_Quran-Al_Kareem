...
class AlHomazahScreen extends StatefulWidget {
  const AlHomazahScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlHomazahScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(104); i++) {
      verses += quran.getVerse(104, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
