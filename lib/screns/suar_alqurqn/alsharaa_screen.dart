...
class AlShuaraaScreen extends StatefulWidget {
  const AlShuaraaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlShuaraaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(26); i++) {
      verses += quran.getVerse(26, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
