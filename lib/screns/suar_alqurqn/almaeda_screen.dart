...
class AlmaedaScreen extends StatefulWidget {
  const AlmaedaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlmaedaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(5); i++) {
      verses += quran.getVerse(5, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
