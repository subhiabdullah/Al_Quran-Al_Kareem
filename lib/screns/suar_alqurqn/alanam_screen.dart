...
class AlanamScreen extends StatefulWidget {
  const AlanamScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlanamScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(6); i++) {
      verses += quran.getVerse(6, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
