...
class AlNasScreen extends StatefulWidget {
  const AlNasScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlNasScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(114); i++) {
      verses += quran.getVerse(114, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
