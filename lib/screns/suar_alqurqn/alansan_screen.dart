...
class AlAnsanScreen extends StatefulWidget {
  const AlAnsanScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlAnsanScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(76); i++) {
      verses += quran.getVerse(76, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
