...
class AlmoaamenonScreen extends StatefulWidget {
  const AlmoaamenonScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlmoaamenonScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(23); i++) {
      verses += quran.getVerse(23, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
