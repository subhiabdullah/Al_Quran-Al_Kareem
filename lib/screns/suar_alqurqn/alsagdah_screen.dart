...
class AlsagdahScreen extends StatefulWidget {
  const AlsagdahScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlsagdahScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(32); i++) {
      verses += quran.getVerse(32, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
