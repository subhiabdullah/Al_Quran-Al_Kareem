...
class AlRahmanScreen extends StatefulWidget {
  const AlRahmanScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlRahmanScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(55); i++) {
      verses += quran.getVerse(55, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
