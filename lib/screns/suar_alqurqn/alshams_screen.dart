...
class AlShamsScreen extends StatefulWidget {
  const AlShamsScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlShamsScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(91); i++) {
      verses += quran.getVerse(91, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
