...
class HoudScreen extends StatefulWidget {
  const HoudScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<HoudScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(11); i++) {
      verses += quran.getVerse(11, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
