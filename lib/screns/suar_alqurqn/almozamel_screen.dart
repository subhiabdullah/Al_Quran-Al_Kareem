...
class AlMozamelScreen extends StatefulWidget {
  const AlMozamelScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlMozamelScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(73); i++) {
      verses += quran.getVerse(73, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
