...
class FaterScreen extends StatefulWidget {
  const FaterScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<FaterScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(35); i++) {
      verses += quran.getVerse(35, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
