...
class AlMotafefenScreen extends StatefulWidget {
  const AlMotafefenScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlMotafefenScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(83); i++) {
      verses += quran.getVerse(83, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
