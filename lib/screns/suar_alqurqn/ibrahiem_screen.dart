...
class IbrahiemScreen extends StatefulWidget {
  const IbrahiemScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<IbrahiemScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(14); i++) {
      verses += quran.getVerse(14, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
