...
class AlShrehScreen extends StatefulWidget {
  const AlShrehScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlShrehScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(94); i++) {
      verses += quran.getVerse(94, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
