...
class AlNahalScreen extends StatefulWidget {
  const AlNahalScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlNahalScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(16); i++) {
      verses += quran.getVerse(16, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
