...
class AlHuguratScreen extends StatefulWidget {
  const AlHuguratScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlHuguratScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(49); i++) {
      verses += quran.getVerse(49, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
