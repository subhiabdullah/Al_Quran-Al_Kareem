...
class AlFealScreen extends StatefulWidget {
  const AlFealScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlFealScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(105); i++) {
      verses += quran.getVerse(105, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
