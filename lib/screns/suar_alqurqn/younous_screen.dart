...
class YounousScreen extends StatefulWidget {
  const YounousScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<YounousScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(10); i++) {
      verses += quran.getVerse(10, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
