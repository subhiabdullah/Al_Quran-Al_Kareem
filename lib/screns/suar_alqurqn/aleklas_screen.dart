...
class AlEklasScreen extends StatefulWidget {
  const AlEklasScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlEklasScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(112); i++) {
      verses += quran.getVerse(112, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
