...
class AlSafatScreen extends StatefulWidget {
  const AlSafatScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlSafatScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(37); i++) {
      verses += quran.getVerse(37, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
