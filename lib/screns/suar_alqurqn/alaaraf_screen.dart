...
class AlAarafScreen extends StatefulWidget {
  const AlAarafScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlAarafScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(7); i++) {
      verses += quran.getVerse(7, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
