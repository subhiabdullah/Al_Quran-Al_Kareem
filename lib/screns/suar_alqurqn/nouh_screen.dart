...
class NouhScreen extends StatefulWidget {
  const NouhScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<NouhScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(71); i++) {
      verses += quran.getVerse(71, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
