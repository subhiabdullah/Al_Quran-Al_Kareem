...
class AlHugorScreen extends StatefulWidget {
  const AlHugorScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlHugorScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(15); i++) {
      verses += quran.getVerse(15, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
