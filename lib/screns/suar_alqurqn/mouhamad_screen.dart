...
class MouhamadScreen extends StatefulWidget {
  const MouhamadScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<MouhamadScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(47); i++) {
      verses += quran.getVerse(47, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
