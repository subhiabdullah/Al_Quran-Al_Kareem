...
class AlMomtahenaScreen extends StatefulWidget {
  const AlMomtahenaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlMomtahenaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(60); i++) {
      verses += quran.getVerse(60, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
