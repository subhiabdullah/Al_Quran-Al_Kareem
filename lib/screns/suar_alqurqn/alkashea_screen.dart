...
class AlKasheaScreen extends StatefulWidget {
  const AlKasheaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlKasheaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(88); i++) {
      verses += quran.getVerse(88, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
