...
class AlNazeatScreen extends StatefulWidget {
  const AlNazeatScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlNazeatScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(79); i++) {
      verses += quran.getVerse(79, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
