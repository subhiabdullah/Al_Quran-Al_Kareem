...
class AlGoumaaScreen extends StatefulWidget {
  const AlGoumaaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlGoumaaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(62); i++) {
      verses += quran.getVerse(62, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
