...
class AlmolkScreen extends StatefulWidget {
  const AlmolkScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlmolkScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(67); i++) {
      verses += quran.getVerse(67, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
