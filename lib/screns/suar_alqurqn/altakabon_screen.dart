...
class ATakabonScreen extends StatefulWidget {
  const ATakabonScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<ATakabonScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(64); i++) {
      verses += quran.getVerse(64, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
