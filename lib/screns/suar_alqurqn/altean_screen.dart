...
class AlTeanScreen extends StatefulWidget {
  const AlTeanScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlTeanScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(95); i++) {
      verses += quran.getVerse(95, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
