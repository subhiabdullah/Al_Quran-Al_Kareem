...
class AlNourScreen extends StatefulWidget {
  const AlNourScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlNourScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(24); i++) {
      verses += quran.getVerse(24, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
