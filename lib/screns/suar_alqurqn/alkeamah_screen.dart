...
class AkeamahScreen extends StatefulWidget {
  const AkeamahScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AkeamahScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(75); i++) {
      verses += quran.getVerse(75, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
