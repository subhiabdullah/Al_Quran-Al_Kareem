...
class AlTubahScreen extends StatefulWidget {
  const AlTubahScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlTubahScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(9); i++) {
      verses += quran.getVerse(9, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
