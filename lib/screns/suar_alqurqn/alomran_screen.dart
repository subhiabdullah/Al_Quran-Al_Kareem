...
class AlOmranScreen extends StatefulWidget {
  const AlOmranScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlOmranScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(3); i++) {
      verses += quran.getVerse(3, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
