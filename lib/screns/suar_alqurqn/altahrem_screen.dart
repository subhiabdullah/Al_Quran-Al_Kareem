...
class AlTahremScreen extends StatefulWidget {
  const AlTahremScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlTahremScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(66); i++) {
      verses += quran.getVerse(66, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
