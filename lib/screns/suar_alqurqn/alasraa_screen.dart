...
class AlAsraaScreen extends StatefulWidget {
  const AlAsraaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlAsraaScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(17); i++) {
      verses += quran.getVerse(17, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
