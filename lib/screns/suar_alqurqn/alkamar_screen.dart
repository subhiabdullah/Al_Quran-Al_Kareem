...
class AlkamarScreen extends StatefulWidget {
  const AlkamarScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlkamarScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(54); i++) {
      verses += quran.getVerse(54, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
