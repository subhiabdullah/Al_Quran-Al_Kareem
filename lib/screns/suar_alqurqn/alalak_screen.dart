...
class AlAlakScreen extends StatefulWidget {
  const AlAlakScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlAlakScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(96); i++) {
      verses += quran.getVerse(96, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
