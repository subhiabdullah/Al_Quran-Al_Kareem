...
class AlTalakScreen extends StatefulWidget {
  const AlTalakScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlTalakScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(65); i++) {
      verses += quran.getVerse(65, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
