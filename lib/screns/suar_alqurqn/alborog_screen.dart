...
class AlBorogScreen extends StatefulWidget {
  const AlBorogScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlBorogScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(85); i++) {
      verses += quran.getVerse(85, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
