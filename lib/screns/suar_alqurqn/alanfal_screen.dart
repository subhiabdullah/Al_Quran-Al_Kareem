...
class AlAnfalScreen extends StatefulWidget {
  const AlAnfalScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlAnfalScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(8); i++) {
      verses += quran.getVerse(8, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
