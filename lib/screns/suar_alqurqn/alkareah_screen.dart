...
class AlKareahScreen extends StatefulWidget {
  const AlKareahScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlKareahScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(101); i++) {
      verses += quran.getVerse(101, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
