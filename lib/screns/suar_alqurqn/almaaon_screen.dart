...
class AlMaaonScreen extends StatefulWidget {
  const AlMaaonScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlMaaonScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(107); i++) {
      verses += quran.getVerse(107, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
