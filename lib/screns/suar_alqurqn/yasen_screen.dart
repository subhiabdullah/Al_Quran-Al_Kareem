...
class YasenScreen extends StatefulWidget {
  const YasenScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<YasenScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(36); i++) {
      verses += quran.getVerse(36, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
