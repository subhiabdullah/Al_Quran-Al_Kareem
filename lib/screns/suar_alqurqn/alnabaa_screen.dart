...
class AlNabaaScreen extends StatefulWidget {
  const AlNabaaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlNabaaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(78); i++) {
      verses += quran.getVerse(78, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
