...
class fusalatScreen extends StatefulWidget {
  const fusalatScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<fusalatScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(41); i++) {
      verses += quran.getVerse(41, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
