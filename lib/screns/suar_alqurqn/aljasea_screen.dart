...
class AlJaseaScreen extends StatefulWidget {
  const AlJaseaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlJaseaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(45); i++) {
      verses += quran.getVerse(45, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
