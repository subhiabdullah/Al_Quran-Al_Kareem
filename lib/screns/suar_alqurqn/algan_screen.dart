...
class AlGanScreen extends StatefulWidget {
  const AlGanScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlGanScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(72); i++) {
      verses += quran.getVerse(72, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
