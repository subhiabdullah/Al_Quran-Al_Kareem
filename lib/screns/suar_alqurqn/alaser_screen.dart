...
class AlAserScreen extends StatefulWidget {
  const AlAserScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlAserScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(103); i++) {
      verses += quran.getVerse(103, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
