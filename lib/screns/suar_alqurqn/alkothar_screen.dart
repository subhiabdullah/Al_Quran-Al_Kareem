...
class AlKotharScreen extends StatefulWidget {
  const AlKotharScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlKotharScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(108); i++) {
      verses += quran.getVerse(108, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
