...
class AlKaderScreen extends StatefulWidget {
  const AlKaderScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlKaderScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(97); i++) {
      verses += quran.getVerse(97, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
