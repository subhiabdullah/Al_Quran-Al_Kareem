...
class AlnesaaScreen extends StatefulWidget {
  const AlnesaaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlnesaaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(4); i++) {
      verses += quran.getVerse(4, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
