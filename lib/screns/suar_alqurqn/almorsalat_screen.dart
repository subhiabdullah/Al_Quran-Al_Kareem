...
class AlMorsalatScreen extends StatefulWidget {
  const AlMorsalatScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlMorsalatScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(77); i++) {
      verses += quran.getVerse(77, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
