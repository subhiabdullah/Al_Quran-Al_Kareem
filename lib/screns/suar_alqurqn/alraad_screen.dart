...
class AlRaadScreen extends StatefulWidget {
  const AlRaadScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlRaadScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(13); i++) {
      verses += quran.getVerse(13, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
