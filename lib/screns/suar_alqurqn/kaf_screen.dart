...
class KafScreen extends StatefulWidget {
  const KafScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<KafScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(50); i++) {
      verses += quran.getVerse(50, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
