...
class AlNamelScreen extends StatefulWidget {
  const AlNamelScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlNamelScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(27); i++) {
      verses += quran.getVerse(27, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
