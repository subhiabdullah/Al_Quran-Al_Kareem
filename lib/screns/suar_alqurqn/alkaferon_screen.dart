...
class AlKaferonScreen extends StatefulWidget {
  const AlKaferonScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlKaferonScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(109); i++) {
      verses += quran.getVerse(109, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
