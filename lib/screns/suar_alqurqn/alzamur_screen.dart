...
class AlZamurScreen extends StatefulWidget {
  const AlZamurScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlZamurScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(39); i++) {
      verses += quran.getVerse(39, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
