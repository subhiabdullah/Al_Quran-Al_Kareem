...
class AlAalahScreen extends StatefulWidget {
  const AlAalahScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlAalahScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(87); i++) {
      verses += quran.getVerse(87, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
