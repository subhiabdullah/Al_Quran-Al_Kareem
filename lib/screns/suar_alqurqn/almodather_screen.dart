...
class AlModatherScreen extends StatefulWidget {
  const AlModatherScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlModatherScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(74); i++) {
      verses += quran.getVerse(74, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
