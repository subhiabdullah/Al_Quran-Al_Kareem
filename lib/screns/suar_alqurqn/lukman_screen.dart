...
class LukmanScreen extends StatefulWidget {
  const LukmanScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<LukmanScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(31); i++) {
      verses += quran.getVerse(31, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
