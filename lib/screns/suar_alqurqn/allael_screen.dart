...
class AlLaelScreen extends StatefulWidget {
  const AlLaelScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlLaelScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(92); i++) {
      verses += quran.getVerse(92, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
