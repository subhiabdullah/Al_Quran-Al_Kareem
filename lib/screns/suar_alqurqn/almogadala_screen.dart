...
class AlMogadalaScreen extends StatefulWidget {
  const AlMogadalaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlMogadalaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(58); i++) {
      verses += quran.getVerse(58, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
