...
class AlZareatScreen extends StatefulWidget {
  const AlZareatScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlZareatScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(51); i++) {
      verses += quran.getVerse(51, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
