...
class AlTakuerScreen extends StatefulWidget {
  const AlTakuerScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlTakuerScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(81); i++) {
      verses += quran.getVerse(81, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
