...
class AlBakaraScreen extends StatefulWidget {
  const AlBakaraScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlBakaraScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(2); i++) {
      verses += quran.getVerse(2, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
