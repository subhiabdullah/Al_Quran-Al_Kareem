...
class AldokanScreen extends StatefulWidget {
  const AldokanScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AldokanScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(44); i++) {
      verses += quran.getVerse(44, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
