...
class lAhzabScreen extends StatefulWidget {
  const lAhzabScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<lAhzabScreen> {
  int _page = 0;
  ...
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(33); i++) {
      verses += quran.getVerse(33, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
