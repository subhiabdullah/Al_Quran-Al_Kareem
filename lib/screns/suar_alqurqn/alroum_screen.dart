...
class AlRoumScreen extends StatefulWidget {
  const AlRoumScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlRoumScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(30); i++) {
      verses += quran.getVerse(30, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
