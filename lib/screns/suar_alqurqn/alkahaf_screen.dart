...
class AlKahafScreen extends StatefulWidget {
  const AlKahafScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlKahafScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(18); i++) {
      verses += quran.getVerse(18, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
