...
class AlTkathorScreen extends StatefulWidget {
  const AlTkathorScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlTkathorScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(102); i++) {
      verses += quran.getVerse(102, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
