...
class SabaaScreen extends StatefulWidget {
  const SabaaScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<SabaaScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(34); i++) {
      verses += quran.getVerse(34, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
