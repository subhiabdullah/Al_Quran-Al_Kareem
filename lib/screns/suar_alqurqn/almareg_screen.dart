...
class AlMaregScreen extends StatefulWidget {
  const AlMaregScreen({Key? key}) : super(key: key);

  @override
  _AlfatehafarScreenState createState() => _AlfatehafarScreenState();
}

class _AlfatehafarScreenState extends State<AlMaregScreen> {
  getVerses() {
    String verses = "";
    for (int i = 0; i < quran.getVerseCount(70); i++) {
      verses += quran.getVerse(70, i + 1, verseEndSymbol: true);
    }
    return verses;
  }
