...
class DuaaNabiAllahMousaScreen extends StatefulWidget {
  const DuaaNabiAllahMousaScreen({Key? key}) : super(key: key);

  @override
  _DuaaAlsafarScreenState createState() => _DuaaAlsafarScreenState();
}

class _DuaaAlsafarScreenState extends State<DuaaNabiAllahMousaScreen> {
  @override
  void initState() {
